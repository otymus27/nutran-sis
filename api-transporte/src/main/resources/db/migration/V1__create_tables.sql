...
-- Criação da tabela de usuários com campo senha_provisoria
...
-- Inserção de 5 usuários de exemplo com senha_provisoria
INSERT INTO tb_usuarios (login, senha, senha_provisoria) VALUES
